...
OUTPUT="${REAL_GRAPH_OUTPUT:-$REPO/docs/research/artifacts/real_graph_dataset}"
MANIFEST="${REAL_GRAPH_MANIFEST:-$OUTPUT/extraction_manifest.csv}"
...
export REAL_GRAPH_MANIFEST="$MANIFEST" REAL_GRAPH_OUTPUT="$OUTPUT"
...
job=$(sbatch --parsable \
  ...
  --export=ALL,REAL_GRAPH_REPO,REAL_GRAPH_PYTHON,REAL_GRAPH_MANIFEST,REAL_GRAPH_OUTPUT,REAL_GRAPH_NUM_SHARDS,REAL_GRAPH_ARGS \
