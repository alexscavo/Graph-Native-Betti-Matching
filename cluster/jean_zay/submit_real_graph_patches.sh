...
export REAL_PATCH_MANIFEST="${REAL_PATCH_MANIFEST:-$REPO/docs/research/artifacts/real_graph_dataset/extraction_manifest.csv}"
export REAL_PATCH_SOURCES="${REAL_PATCH_SOURCES:-$REAL_PATCH_DATASET_ROOT/$dataset_folder/vascular_graph_sources/optimal_radius_0p75x_c095}"
export REAL_PATCH_OUTPUT="${REAL_PATCH_OUTPUT:-$REAL_PATCH_DATASET_ROOT/$dataset_folder/vascular_patches/optimal_radius_0p75x_c095}"
...
SBATCH_ARGS=(
  ...
  --export=ALL,REAL_PATCH_REPO,REAL_PATCH_PYTHON,REAL_PATCH_MANIFEST,REAL_PATCH_DATASET,REAL_PATCH_DATASET_ROOT,REAL_PATCH_SOURCES,REAL_PATCH_SPLIT,REAL_PATCH_OUTPUT,REAL_PATCH_EVIDENCE
)
